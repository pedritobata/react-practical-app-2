export const CLIENT_ID = "PedroMar-myamazon-SBX-87cf12021-46a66edc";
export const CLIENT_ID_PROD = "PedroMar-myamazon-PRD-27a727799-eba6a00b";
export const REDIRECT_ID = "Pedro_Martinez-PedroMar-myamaz-hlemvy"; //RuName
export const REDIRECT_ID_PROD = "Pedro_Martinez-PedroMar-myamaz-wpssjlmv";
